...
public class lead {
	public static void main(String[] args) throws InterruptedException, IOException {
	    ...
	    driver.findElement(By.id("Leads_editView_fieldName_firstname")).sendKeys("rahul");
	    driver.findElement(By.id("Leads_editView_fieldName_lastname")).sendKeys("motipalle");
	    driver.findElement(By.id("Leads_editView_fieldName_phone")).sendKeys("8624984001");
	    driver.findElement(By.id("Leads_editView_fieldName_company")).sendKeys("ram internationals");
	    driver.findElement(By.id("Leads_editView_fieldName_mobile")).sendKeys("992569309");
	    driver.findElement(By.id("Leads_editView_fieldName_designation")).sendKeys("MD & CEO");
	    driver.findElement(By.id("Leads_editView_fieldName_fax")).sendKeys("rahul@123");
	    ...
	    driver.findElement(By.id("Leads_editView_fieldName_email")).sendKeys("ram@yahoo.com");
	    ...
	    driver.findElement(By.id("Leads_editView_fieldName_website")).sendKeys("https://www.ramindustries.com");
	    ...
	    driver.findElement(By.id("Leads_editView_fieldName_secondaryemail")).sendKeys("rama@yahoo.com");
	    ...
	    Thread.sleep(1000);
	    driver.findElement(By.id("Leads_editView_fieldName_lane")).sendKeys("latur");
	    driver.findElement(By.id("Leads_editView_fieldName_pobox")).sendKeys("latur");
	    ...
	    driver.findElement(By.id("Leads_editView_fieldName_description")).sendKeys("KFJFJIJGNINI");
